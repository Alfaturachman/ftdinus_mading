            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item <?php echo ($this->uri->segment(1) == 'jadwal') ? 'active' : ''; ?>">
                            <a href="<?php echo site_url('jadwal'); ?>" class="sidebar-link">
                                <i class="bi bi-heart-pulse-fill"></i>
                                <span>Input Jadwal</span>
                            </a>
                        </li>

                        <li class="sidebar-item <?php echo ($this->uri->segment(1) == 'ruang') ? 'active' : ''; ?>">
                            <a href="<?php echo site_url('ruang'); ?>" class="sidebar-link">
                                <i class="bi bi-heart-pulse-fill"></i>
